                        ...
                        <ul className="sidebarList">
                            <Link to="/" className="link">
                                <li className="sidebarListItem active flex items-center my-1 text-gray-900 border-l-4  hover:border-indigo-700 border-transparent hover:text-gray-700 hover:bg-gray-100 p-1">
                                    <RiDashboardLine size="20px" className="sidebarIcon mr-1" />
                                    <span className="text-lg">Dashboard</span>
                                </li>
                            </Link>
                            <Link to="/users" className="link">
                                <li className="sidebarListItem active flex items-center my-1 text-gray-900 border-l-4  hover:border-indigo-700 border-transparent hover:text-gray-700 hover:bg-gray-100 p-1">
                                    <BiUser size="20px" className="sidebarIcon mr-1" />
                                    <span className="text-lg">Users</span>
                                </li>
                            </Link>
                            <Link to="/products" className="link">
                                <li className="sidebarListItem active flex items-center my-1 text-gray-900 border-l-4  hover:border-indigo-700 border-transparent hover:text-gray-700 hover:bg-gray-100 p-1">
                                    <CgProductHunt size="20px" className="sidebarIcon mr-1" />
                                    <span className="text-lg">Products</span>
                                </li>
                            </Link>
                            <Link to="/transactions" className="link">
                                <li className="sidebarListItem active flex items-center my-1 text-gray-900 border-l-4  hover:border-indigo-700 border-transparent hover:text-gray-700 hover:bg-gray-100 p-1">
                                    <AiOutlineTransaction size="20px" className="sidebarIcon mr-1" />
                                    <span className="text-lg">Transactions</span>
                                </li>
                            </Link>
                            <Link to="/sales" className="link">
                                <li className="sidebarListItem active flex items-center my-1 text-gray-900 border-l-4  hover:border-indigo-700 border-transparent hover:text-gray-700 hover:bg-gray-100 p-1">
                                    <GiSellCard size="20px" className="sidebarIcon mr-1" />
